  ...
  return (
    <IonPage>
      ...
      <IonContent fullscreen className="ion-padding">
        ...
        <IonCard id="card1" onClick={goToClickCounter} style={{ width: '350px', cursor: 'pointer' }} color="danger">
              <IonCardContent style={{ height: '70px', fontSize: '30px', display: 'flex', alignItems: 'center', padding: 0 }}>
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '80px', flex: '20%', backgroundColor: 'var(--ion-color-light)', padding: 0 }}>
                  ...
                  <img alt="" id="click_counter" src="../src/assets/img/Click Counter.gif" />
                </div>
        ...
        <IonCard id="card2" onClick={goToCalculator} style={{ width: '350px', cursor: 'pointer' }} color="danger">
        <IonCardContent style={{ height: '70px', fontSize: '30px', display: 'flex', alignItems: 'center', padding: 0 }}>
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '80px', flex: '20%', backgroundColor: 'var(--ion-color-success)', padding: 0 }}>
                  {/* <IonIcon icon={pulseOutline} slot="start" /> */}
          ...
          <IonCardContent style={{ height: '70px', fontSize: '30px', display: 'flex', alignItems: 'center', padding: 0 }}>
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '80px', flex: '20%', backgroundColor: 'var(--ion-color-warning)', padding: 0 }}>
                  {/* <IonIcon icon={pulseOutline} slot="start" /> */}
